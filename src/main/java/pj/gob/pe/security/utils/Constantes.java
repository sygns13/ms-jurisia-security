...
public class Constantes {
    ...
    public static final Long TIPO_USER_SA = 1L;
    public static final Long TIPO_USER_ADMIN = 2L;
    public static final Long TIPO_USER_USUARIO = 3L;
    public static final Long TIPO_USER_USUARIO_REPORTES = 4L;
    ...
    public static final Integer TIPO_DOCUMENTO_CARNET_PASAPORTE = 4;
